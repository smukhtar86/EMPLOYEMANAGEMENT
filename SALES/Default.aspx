<%@ Page Title="" Language="C#" MasterPageFile="~/SALES/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="USER_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" runat="server" id="sp_CurrentStock">0<small></small></span>
                        <span class="info-box-number" runat="server" id="sp_CurrentStock1"></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-orange-active"><a onclick="ShowHide('ContentPlaceHolder1_sp_TODAY_SALE_QNTY1'); ShowHide('today_sale_link1');ShowHide('today_sale_link2');"><i class="ion ion-ios-cart" style="color: white;"></i></a>
                        <br />
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="SaleReport.aspx"><b>Todays Sale</b></a></span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="SaleReport.aspx"><b>Total Sales/Return</b></a></span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="VendorDues.aspx"><b>Credit Amount</b></a></span>
                        <span class="info-box-number" runat="server" id="sp_CREDIT">0</span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="AddStock.aspx"><b>Purchase Order</b></a></span>
